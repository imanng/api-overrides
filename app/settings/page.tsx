    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Use this user key to access your overrides when your IP address
                changes. Keep this key secure and don't share it publicly.
              </p>
              ...
              {isLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="mt-4 p-3 bg-muted rounded text-xs">
                    <p className="font-semibold mb-1">Access URL:</p>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Import Overrides</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
              ...
              >
                {isImporting ? "Importing..." : "📥 Import Overrides"}
              </Button>
            </CardContent>
          </Card>
        </div>
      ...
      <Dialog open={showImportDialog} onOpenChange={setShowImportDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Import Overrides with User Key</DialogTitle>
            <DialogDescription>
